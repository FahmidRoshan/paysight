...
def generate_product_events(n_events, users_df):
    ...
    for _ in range(n_events):
        ...
        product_events.append({
            ...
            "device_id": user["device_id"] if random_value > 0.2 else str(uuid.uuid4()),
            "location": user["location"] if random_value > 0.2 else random.choice(locations),
        })
