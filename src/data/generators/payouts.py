...
def generate_payouts(merchants_df, transactions_df):
    payouts = []
    ...
    for merchant_id, group in grouped_txns:
        ...
        for _ in range(random.randint(1, 3)):
            txn_sample = group.sample(n=random.randint(5, 20))
            ...
            payouts.append({
                ...
                "payout_statuses": random.choice(payout_statuses, weights = [0.9, 0.5, 0.05])[0],
